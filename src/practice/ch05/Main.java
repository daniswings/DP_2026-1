...
public class Main {
    public static void main(String[] args) {
        // 아래 문장 컴파일 에러: Singleton() has private access in Singleton
        // Singleton s1 = new Singleton();

        // Singleton이라는 클래스에 getInstance()라는 메소드를 호출해서 객체를 얻어감
        Singleton s2 = Singleton.getInstance();

        // 여기까지 출력 시 같은 문장 2번 출력됨 -> 아직 Singleton 객체가 생성된 것은 아님을 알 수 있음
